...
with st.container():
    with st.sidebar:
        ...
        st.write("""<h3 style = "text-align: center;"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2zS3AGhX-xYig2B0kiKL9DtTRb5PlcyHiIg&usqp=CAU" width="120" height="120"></h3>""",unsafe_allow_html=True), 
